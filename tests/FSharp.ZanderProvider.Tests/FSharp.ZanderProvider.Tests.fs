module FSharp.ZanderProviderTests
...
type Generative2 = FSharp.ZanderProvider.GenerativeProvider<2>
type Generative4 = FSharp.ZanderProvider.GenerativeProvider<4>
